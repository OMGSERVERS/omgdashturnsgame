	...
	create = function(self)
		...
		return {
			...
			set_lobby_screen = function(instance, screen_ids)
				screen_qualifier = client_screen.LOBBY_SCREEN
				collection_ids = screen_ids
			end,
			is_lobby_screen = function(instance)
				return screen_qualifier == client_screen.LOBBY_SCREEN
			end,
			...
			set_joining_screen = function(instance, screen_ids)
				screen_qualifier = client_screen.JOINING_SCREEN
				collection_ids = screen_ids
			end,
			is_joining_screen = function(instance)
				return screen_qualifier == client_screen.JOINING_SCREEN
			end,
			...
			set_match_screen = function(instance, screen_ids)
				screen_qualifier = client_screen.MATCH_SCREEN
				collection_ids = screen_ids
			end,
			is_match_screen = function(instance)
				return screen_qualifier == client_screen.MATCH_SCREEN
			end,
			...
			set_leaving_screen = function(instance, screen_ids)
				screen_qualifier = client_screen.LEAVING_SCREEN
				collection_ids = screen_ids
			end,
			is_leaving_screen = function(instance)
				return screen_qualifier == client_screen.LEAVING_SCREEN
			end,
			...
			set_ops_screen = function(instance, screen_ids)
				screen_qualifier = client_screen.OPS_SCREEN
				collection_ids = screen_ids
			end,
			is_ops_screen = function(instance)
				return screen_qualifier == client_screen.OPS_SCREEN
			end,
