...
players_container = {
	...
	add_player = function(self, client_id, player)
		if self.players[client_id] then
			print(os.date() .. " [PLAYER_CONTAINER] Player was already added, skip operations, client_id=" .. client_id)
			return false
		else
			self.players[client_id] = player
			print(os.date() .. " [PLAYER_CONTAINER] Player was added, client_id=" .. client_id)
			return true
		end
	end,
	...
	delete_player = function(self, client_id)
		if self.players[client_id] then
			...
			print(os.date() .. " [PLAYER_CONTAINER] Player was deleted, client_id=" .. client_id)
			return true
		else
			print(os.date() .. " [PLAYER_CONTAINER] Player was not found to delete, client_id=" .. client_id)
			return false
		end
	end,
